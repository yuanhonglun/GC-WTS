    ...
    def Main(self, msp_path, rt_data_path, set_name_list, name_list_path, mz_min, mz_max, outpath, rt_window,
        ...
        if combination_result_df is None:
            ...
            for targeted_compound, nearby_compound_list in nearby_compound_dic.items():
                ...
                if nearby_compound_list == [targeted_compound]:
                    ...
                    combination_result_df.loc[targeted_compound, "SCL_Note"] = "No nearby substances."
                    ...
                    if matrix_1.shape[0] < 2:
                        ...
                        combination_result_df.loc[targeted_compound, "Note"] = ("No nearby substances; after applying "
                                                                                "minimum ion response filtering, "
                                                                                "the available number of ions is less "
                                                                                "than 2, and they are not considered "
                                                                                "for filtering.")
                    else:
                    ...
                    if temp_df.shape[1] < 2:
                        combination_result_df.loc[targeted_compound, "Ion_Combination"] = "NA"
                        combination_result_df.loc[targeted_compound, "Note"] = ("After applying minimum ion response "
                                                                                "filtering, the available number of "
                                                                                "ions is less than 2, and they are "
                        ...
                        if temp_df.shape[0] == 1:
                            ...
                            if temp_name == targeted_compound:
                                ...
                                if matrix_1.shape[0] < 2:
                                    combination_result_df.loc[targeted_compound, "Ion_Combination"] = "NA"
                                    combination_result_df.loc[targeted_compound, "Note"] = ("After applying minimum "
                                                                                            "ion response filtering, "
                                ...
                                if int((combination_df.max())[0]) >= int(
                                        ...
                                        if candidate_list == []:
                                            if int((combination_df.max())[0]) >= int(temp_df.shape[0] - 1):
                                                ...
                                                combination_result_df.loc[str(targeted_compound), "Ion_Combination"] = \
                                                    combination_array[0]
                                                combination_result_df.loc[
                                                    str(targeted_compound), "Note"] = ("The number of ions is less "
                                                                                       "than the minimum required, "
                                                                                       "but separation has been "
                                                ...
                                                combination_result_df.loc[
                                                    str(targeted_compound), "Note"] = ("No ions available; separation "
                                                                                       "not achieved.")
                                                flag = False
                                                break
                                    ...
                                    if flag == True:
                                        ...
                                        if len(difference_count_df_2) > 0:
                                            ...
                                            combination_result_df.loc[
                                                str(targeted_compound), "Note"] = ("Bug: The 'difference_count_df' is "
                                                                                   "empty.")
                                            flag = False
        ...
        for name in name_list:
            if name in RT_data.index.values.tolist():
                ...
                error_df.loc[len(error_df)] = [name, "The substance is not present in the RT list."]
