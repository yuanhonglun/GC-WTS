...
class Ui_Form_None(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.label_7.setText(_translate("Form", "定性参数"))
        self.label_3.setText(_translate("Form", "峰组Match系数："))
        self.label_2.setText(_translate("Form", "峰组R Match系数："))
        self.label_4.setText(_translate("Form", "参与定性group所含最少离子数："))
        self.label_8.setText(_translate("Form", "峰组打分权重："))
        self.label_6.setText(_translate("Form", "直接搜索打分权重："))
        self.label_9.setText(_translate("Form", "相似性阈值："))
        self.label.setText(_translate("Form", "Step3:不选择"))
