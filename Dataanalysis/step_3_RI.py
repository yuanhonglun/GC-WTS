...
class Ui_Form_RI(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.label_3.setText(_translate("Form", "Library search window:"))
        self.label_14.setText(_translate("Form", "Maximum RI:"))
        self.label_2.setText(_translate("Form", "Peak group Match weight:"))
        self.label_4.setText(_translate("Form", "Peak group Reverse Match weight:"))
        self.label_5.setText(_translate("Form", "Minimum ions number in peak group for identification:"))
        self.label_16.setText(_translate("Form", "Peak group search score weight:"))
        self.label_17.setText(_translate("Form", "Direct search score\n"
"weight:"))
        self.label_18.setText(_translate("Form", "Similarity score\n"
"threshold:"))
        self.label_6.setText(_translate("Form", "Calculate RI penalty:"))
        self.label_7.setText(_translate("Form", "RI window:"))
        self.doubleSpinBox_5.setPrefix(_translate("Form", "±"))
        self.label_9.setText(_translate("Form", "RI window scale:"))
        self.label_8.setText(_translate("Form", "Level factor:"))
        self.label_10.setText(_translate("Form", "Maximum penalty:"))
        self.label_11.setText(_translate("Form", "No RI penalty:"))
        self.label_15.setText(_translate("Form", "Inaccurate RI threshold:"))
        self.label_19.setText(_translate("Form", "Inaccurate RI\n"
"level factor:"))
